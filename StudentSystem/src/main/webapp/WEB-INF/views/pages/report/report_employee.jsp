			...
			<div class="card-body collapse in">
				<div class="card-block">
					<form class="form form-horizontal form-bordered"
						action="<c:url value='/report_employee' />" method='GET'>
						<div class="form-body">
			...
			<div class="card-body">
				...
				<div class="card-block">
					...
					<form class="form form-horizontal"
						action="<c:url value='/thong-ke-bao-cao/menu' />" method='GET'>
						<div class="tab-content px-1 pt-1">
							...
							<div class="tab-pane" id="tab32" aria-labelledby="base-tab32">
								...
								<section id="chartjs-pie-charts">
									...
									<br>
									<div class="card-header">
										<div id="line_chart_week" style="width: 900px; height: 300px;"></div>
									</div>
									<hr>
									<br>
									<div class="dataTables_scroll" align="right">
...
function drawChartWeek(){
    ...
    // Set chart options
   var options = {
    title: "Thống kê Nhân viên mới trong Tuần",
    is3D : true,
    pieSliceText: 'label',
    tooltip :  {showColorCode: true},
    'width' : 900,
...
function drawMonthReport(){
   ...
   // Set chart options
  var options = {
   title: "Báo Cáo Nhân viên mới trong tháng",
   is3D : true,
   pieSliceText: 'label',
   tooltip :  {showColorCode: true},
   'width' : 900,
...
function drawYearReport(){
      ...
      // Set chart options
     var options = {
      title: "Báo Cáo Nhân viên mới trong Năm",
      is3D : true,
      pieSliceText: 'label',
      tooltip :  {showColorCode: true},
      'width' : 900,
...
function downloadDayTemplate(){
	$.blockUI();
	$.ajax({
		url : "<c:url value='/report_employee/export-employeeDayChart-template' />",
		type : 'GET',
...
function downloadWeekTemplate(){
	$.blockUI();
	$.ajax({
		url : "<c:url value='/report_employee/export-employeeWeekChart-template' />",
		type : 'GET',
		success : function(response) {
			if (response.status === 200) {
				downloadFile(response.data, ".xlsx");
...
function downloadMonthTemplate(){
	$.blockUI();
	$.ajax({
		url : "<c:url value='/report_employee/export-employeeMonthChart-template' />",
		type : 'GET',
		success : function(response) {
			if (response.status === 200) {
				downloadFile(response.data, ".xlsx");
...
function downloadYearTemplate(){
	$.blockUI();
	$.ajax({
		url : "<c:url value='/report_employee/export-employeeYearChart-template' />",
		type : 'GET',
		success : function(response) {
			if (response.status === 200) {
				downloadFile(response.data, ".xlsx");
