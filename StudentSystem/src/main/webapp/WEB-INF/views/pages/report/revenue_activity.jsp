			...
			<div class="card-body collapse in">
				<div class="card-block">
					<form class="form form-horizontal form-bordered"
						action="<c:url value='/revenue_activities' />" method='GET'>
						<div class="form-body" >
	...
	<div class="col-xl-12 col-lg-12">
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="card-header">
					<h4 class="card-title">Thống kê danh thu</h4>
					<a class="heading-elements-toggle"><i
						class="fa fa-ellipsis-v font-medium-3"></i></a>
				</div>
				<div class="card-block">
					...
					<div class="tab-content px-1 pt-1">
								...
								<div class="col-xs-12">
									<div class="card">
										<div class="card-header">
											...
											<div id="pie_chart_week" style="width: 900px; height: 300px;"></div>
										</div>
										<hr>
										<br>
										<div class="card-header">
										...
										<br>
										<div class="card-header">
											<div id="bar_chart_week" style="width: 900px; height: 300px;"></div>
										</div>
										<div class="row">
											<div class="col-xs-12">
												<div class="card">
						...
						<div class="tab-pane" id="tab33" aria-labelledby="base-tab33">
							...
							<section id="chartjs-pie-charts">
								<!--  Pie Chart -->
								<div class="card-header">
									<div id="bar_chart_month" style="width: 900px; height: 500px;"></div>
								</div>
								<hr>
								<br>
								<div class="card-header">
									<div id="pie_chart_month" style="width: 900px; height: 500px;"></div>
								</div>
								<hr>
								<br>

								<div class="card-header">
									<div id="line_chart_month" style="width: 900px; height: 500px;"></div>
								</div>
						...
						<div class="tab-pane" id="tab34" aria-labelledby="base-tab34">
							...
							<section id="chartjs-pie-charts">
								<!-- Simple Pie Chart -->
								<div class="card-header">
									<div id="bar_chart_year" style="width: 900px; height: 500px;"></div>
								</div>
								<hr>
								<br>
								<div class="card-header">
									<div id="line_chart_year" style="width: 900px; height: 500px;"></div>
								</div>

								<hr>
								<br>
								<div class="card-header">
									<div id="pie_chart_year" style="width: 900px; height: 500px;"></div>
								</div>
								<div class="row">
									<div class="col-xs-12">
										<div class="card">
...
<script type="text/javascript">
    ...
    function drawChartWeek(){
        ...
        // Set chart options
       var options = {
        title: "Thống kê Doanh thu mới trong Tuần",
        is3D : true,
        pieSliceText: 'label',
        tooltip :  {showColorCode: true},
        'width' : 900,
    ...
    function downloadDayTemplate(){
    	$.blockUI();
    	$.ajax({
    		url : "<c:url value='/revenue_activities/export-RevenueActivitiesDayChart-template' />",
    		type : 'GET',
    ...
    function downloadWeekTemplate(){
    	$.blockUI();
    	$.ajax({
    		url : "<c:url value='/revenue_activities/export-RevenueActivitiesWeekChart-template' />",
    		type : 'GET',
    		success : function(response) {
    			if (response.status === 200) {
    				downloadFile(response.data, ".xlsx");
    ...
    function downloadMonthTemplate(){
    	$.blockUI();
    	$.ajax({
    		url : "<c:url value='/revenue_activities/export-RevenueActivitiesMonthChart-template' />",
    		type : 'GET',
    		success : function(response) {
    			if (response.status === 200) {
    				downloadFile(response.data, ".xlsx");
    ...
    function downloadYearTemplate(){
    	$.blockUI();
    	$.ajax({
    		url : "<c:url value='/revenue_activities/export-RevenueActivitiesYearChart-template' />",
    		type : 'GET',
    		success : function(response) {
    			if (response.status === 200) {
    				downloadFile(response.data, ".xlsx");
