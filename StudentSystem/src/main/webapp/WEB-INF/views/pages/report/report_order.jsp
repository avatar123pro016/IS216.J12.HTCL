			...
			<div class="card-body collapse in">
				<div class="card-block">
					<form class="form form-horizontal form-bordered"
						action="<c:url value='/report_orders' />" method='GET'>
						<div class="form-body">
...
<div class="row">
	<div class="col-xl-12 col-lg-12">
		<div class="card">
			...
			<div class="card-header">
				<h4 class="card-title">Thống kê sảm phẩm </h4>
				<a class="heading-elements-toggle"><i
					class="fa fa-ellipsis-v font-medium-3"></i></a>
			</div>
				<div class="card-block">
...
<script type="text/javascript">
    ...
    function downloadDayTemplate(){
    	$.blockUI();
    	$.ajax({
    		url : "<c:url value='/report_orders/export-orderDayChart-template' />",
    		type : 'GET',
    ...
    function downloadWeekTemplate(){
    	$.blockUI();
    	$.ajax({
    		url : "<c:url value='/report_orders/export-orderWeekChart-template' />",
    		type : 'GET',
    		success : function(response) {
    			if (response.status === 200) {
    				downloadFile(response.data, ".xlsx");
    ...
    function downloadMonthTemplate(){
    	$.blockUI();
    	$.ajax({
    		url : "<c:url value='/report_orders/export-ordersMonthChart-template' />",
    		type : 'GET',
    		success : function(response) {
    			if (response.status === 200) {
    				downloadFile(response.data, ".xlsx");
    ...
    function downloadYearTemplate(){
    	$.blockUI();
    	$.ajax({
    		url : "<c:url value='/report_orders/export-orderYearChart-template' />",
    		type : 'GET',
    		success : function(response) {
    			if (response.status === 200) {
    				downloadFile(response.data, ".xlsx");
