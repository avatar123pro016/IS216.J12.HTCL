...
public class SMSHelper {
	...
	final String APIKey="978CBA5F18EE0A1E53A422774D5C28";//Dang ky tai khoan tai esms.vn de lay Key
	final String SecretKey="9959D879FC987A46DE1BDEADBAD6BA";
	...
	public SMSHelper(String message, String phone) {
		super();
		this.message = message;
		this.phone = phone;
	}
	...
	public String sendGetJSON() throws IOException {
		...
		String url = "http://rest.esms.vn/MainService.svc/json/SendMultipleMessage_V4_get?ApiKey=" + URLEncoder.encode(APIKey, "UTF-8") + "&SecretKey=" + URLEncoder.encode(SecretKey, "UTF-8") +"&Brandname=Verify"+ "&SmsType=2&Phone=" + URLEncoder.encode(phone, "UTF-8") + "&Content=" + URLEncoder.encode(message, "UTF-8");
